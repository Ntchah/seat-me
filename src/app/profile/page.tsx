          ...
          <div className="overflow-hidden w-full h-full py-16 relative z-10">
               ...
               {profile && (
                    <div className="flex flex-col items-center z-10 text-white relative pt-20 space-y-4">
                         ...
                         <Link href="/mybooking" className="mt-6 inline-block py-2 px-6 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-white font-semibold rounded-lg shadow-lg hover:from-yellow-500 hover:via-yellow-600 hover:to-yellow-700 transition-all duration-300">
                                   View Bookings
                         </Link>
                    </div>
               )}
